...
public class DefaultBattleGUI : BattleGUI{
        ...
        CustomEvent levelstart = new CustomEvent("level_start")
    {
        ...
        print("Evento level_start queNivel" + levelStartIndex);
        print("Evento level_start protagonista" + UFE.config.player1Character.characterName);
        print("Evento level_start enemigo" + UFE.config.player2Character.characterName);
        print("Evento level_start modo" + modo);
...
;
                    ...
                    CustomEvent levelcomplete = new CustomEvent ("level_complete")
    {
                    ...
                    print("Evento level_complete queNivel: " + levelIndexComplete);
                    print("Evento level_complete protagonista: " + this.player1GUI.name.text);
                    print("Evento level_complete enemigo: " + this.player2GUI.name.text);
                    print("Evento level_complete modo: " + modoLevelComplete);
                    ...
                    CustomEvent gameover = new CustomEvent("game_over")
    {
                    ...
                    Debug.Log("evento game_over protagonista= " + this.player1GUI.name.text);
                   
                 
                    Debug.Log("evento game_over enemigo = " + this.player2GUI.name.text);

                    Debug.Log("evento game_over queNivel = " + levelindexGameOver);

                    Debug.Log("evento game_over modo = " + modoGameOver);
                    Debug.Log("evento game_over numRondas = " + UFE.config.currentRound);
